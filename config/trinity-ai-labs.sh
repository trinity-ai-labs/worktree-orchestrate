...
# `pnpm gate` wraps `check && test` in one machine-wide lock so parallel worktrees
# don't stack their vite builds + vitest forks and saturate the box.
GATE_CMD="pnpm gate"
